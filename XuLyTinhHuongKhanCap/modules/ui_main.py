...
" QScrollBar:horizontal { background: rgb(52, 59, 72); }")
        ...
        self.frame_size_grip = QFrame(self.btn_home)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.temperature_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#ffffff;\">Monday</span></p></body></html>"))
